...
public class EmpleadoBaseMasComision extends EmpleadoPorComision {
    ...
    public EmpleadoBaseMasComision(String primerNombre, String apellidoPaterno, String numeroSeguroSocial,
            double tarifaComision, double ventasBrutas, double salarioBase, Fecha fechaNacimiento) {
        super(primerNombre, apellidoPaterno, numeroSeguroSocial, tarifaComision, ventasBrutas, fechaNacimiento);
