...
public class PruebaPolizaAuto {
    public static void main(String[] args) {
        ...
        JOptionPane.showMessageDialog(null, String.format("Tu numero de póliza es: %d%nTu marca y modelo son: %s%nTu municipio es: %s%nTu municipio no tiene multa? %b%n", instancia1.getNumeroCuenta(), instancia1.getMarcoYModelo(), instancia1.getMunicipio(), instancia1.municipioSinMulta() ), "Datos objeto 1 mediante constructor", 1);

        instancia1.setNumeroCuenta(Integer.parseInt(JOptionPane.showInputDialog("Escribe tu numero de póliza:")));
